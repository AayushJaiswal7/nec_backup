...
`}
                    ...
                    <div className=" mt-0 bg-[#FFF8F5] border border-gray-300 rounded-lg overflow-hidden shadow-sm flex">

                        {/* Left Activities */}
                        {/* Left Activities */}
                        <div className="border-r border-gray-300 bg-white pt-2 transition-all duration-300 ease-in-out" style={{ width: isActivitiesCollapsed ? '60px' : '240px' }}>
                        ...
                        <div className="flex-1 bg-white  pt-2">
                            <div className=" items-center justify-between mb-4">
                                ...
                                <button className="flex text-blue-600 mt-2   px-4 gap-1 text-xs font-medium hover:underline">
